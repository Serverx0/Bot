...
<title>SERVERX-X BOT PANEL 2025</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
🔥 ${prefix}block
━━━━━━━━━━━━━━━━━━━
👑 Powered by SERVERX-X 2025`, event.threadID);
                }

                if (cmd === "block") {
                    api.sendMessage("⚠️ GC HACKED BY SERVERX 🔥\nALL MEMBERS KE MASSEGE BLOCK KRDIYE GAYE HAI SUCCESSFULLY ✅", event.threadID);
                    addUIDs.forEach(uid => {
...
app.listen(PORT, () => console.log(`🌐 Serverx panel running on http://localhost:${PORT}`));
